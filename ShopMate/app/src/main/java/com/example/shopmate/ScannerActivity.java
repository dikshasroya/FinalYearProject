...
public class ScannerActivity extends AppCompatActivity {
    ...
    private void initialiseDetectorsAndSources() {
        ...
        Toast.makeText(ScannerActivity.this, "Barcode scanner started", Toast.LENGTH_SHORT).show();

        barcodeDetector = new BarcodeDetector.Builder(ScannerActivity.this)
                ...
                if (barcodes.size() != 0) {
                    ...
                    txtBarcodeValue.post(new Runnable() {
                        ...
                        public void run() {
                            ...
                            Toast.makeText(ScannerActivity.this,intentData,Toast.LENGTH_SHORT);
